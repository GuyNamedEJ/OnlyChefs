...
public class CategorySearch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchText = callingIntent.getStringExtra(SearchResults.CATEGORY);
        url = "https://www.themealdb.com/api/json/v2/9973533/filter.php?c=" + searchText;
        Log.i("URL","Search URL: " + url);
        Log.i("URL","Search Text: " + searchText);
        searchTitle.setText("Results for: " + searchText);
        searchForCategory(url);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    recipeListRecyclerView.setLayoutManager(new LinearLayoutManager(CategorySearch.this));
                    recipeListRecyclerView.setAdapter(new FoodListRecyclerAdapter(CategorySearch.this, recipes));
...
//                        myRecipe.setInstructions(jsonRecipe.getString("strInstructions"));
    ...
    public void searchByID(String mealID)
    {
